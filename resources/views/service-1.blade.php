...
<div class="w-full">
    ...
    <section class="bg-black flex items-center justify-center py-10 px-10">
        ...
        >
            ...
            >
                ...
                <a href="{{ route('service-2') }}" class="btn" title="category">
                    <svg
                        width="47"
                        height="47"
                        viewBox="0 0 47 47"
    ...
    <section class="w-full bg-black flex justify-center items-center">
        <div class="w-full max-w-[1440px] flex flex-col gap-20 px-10 2xl:px-0">
            ...
            'assets/img/service-1.png') @slot('title', 'Desarrollo de software')
            @endcomponent
            ...
            >
                ...
                'Desarrollo a tu medida:') @slot('description', 'Transformamos
                ...
                específicos.') @endcomponent
                @component('_components.card-service') @slot('title',
                'Innovación Tecnológica:') @slot('description', 'En PDT, no solo
                ...
                revolucionario.') @endcomponent
                @component('_components.card-service') @slot('title',
                'Experiencia Fluida de Usuario:') @slot('description',
                'Construimos software que no solo resuelve problemas, sino que
                ...
                impresión duradera.') @endcomponent
            </div>
            ...
            >
                @component('_components.card-service') @slot('title',
                'Eficiencia en el Desarrollo:') @slot('description', 'El tiempo
                ...
                que escribimos.') @endcomponent
                @component('_components.card-service') @slot('title', 'Seguridad
                en cada Aspecto:') @slot('description', 'La seguridad no es una
                ...
                de tu proyecto.') @endcomponent
                @component('_components.card-service') @slot('title', 'Soporte
                Continuo:') @slot('description', 'No terminamos cuando el
                ...
                asegurar el éxito a largo plazo.') @endcomponent
            </div>
        </div>
    </section>
